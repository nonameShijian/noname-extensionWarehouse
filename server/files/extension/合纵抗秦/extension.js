					...
					skill: {
						hezongkangqin_player_init: {
							...
							content: function() {
								...
								/*event.negSKillList = {};
								Object.defineProperty(event.negSKillList, 'toString', {
									enumerable: false,
									//不可枚举
									value: function() {
										var keys = Object.keys(this);
										if (keys.length == 0) return '';
										var str = '</br>技能冲突组合</br>';
										for (var i = 0; i < keys.length; i++) {
											this[keys[i]].forEach(value => {
												str += `${ lib.translate[keys[i]] } + ${ lib.translate[value] } `;
											});
										}
										str += '</br>';
										return str;
